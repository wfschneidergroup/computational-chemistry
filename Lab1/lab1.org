#+TITLE:Computational Chemistry Laboratory I (CBE 60553)
...
* Introduction to Linux (15 minutes)
...
* The very least you have to know about GNU Emacs (20 minutes)
...
- We could change these shortcuts to work like what we are used to, but ...

#+caption: Emacs graphic from @sachac
[[./images/Emacs.png]]
...
* Introduction to Python (40 minutes)
